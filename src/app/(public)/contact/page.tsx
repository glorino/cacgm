    ...
    <>
      <section className="relative pt-[160px] pb-[100px] text-center" style={{ background: '#1A374F' }}>
        <div className="max-w-[992px] mx-auto px-5">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-[12px] font-bold uppercase tracking-[2px] text-[#E46C63] mb-3">Contact</motion.p>
      ...
      <section className="py-[100px]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-[30px]">
          <div className="grid lg:grid-cols-5 gap-[50px]">
            {/* Contact Info */}
            <div className="lg:col-span-2">
              <h2 className="text-[28px] font-['Arno_Pro',serif] text-[#222] mb-[30px]">Contact Information</h2>
              <div className="space-y-5">
                {[
                  ...
                  <div key={item.label} className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-[13px] font-bold uppercase tracking-[1px] text-[#69757B] mb-1">{item.label}</p>
            ...
            <div className="lg:col-span-3">
              <form className="space-y-[20px]">
                <div className="grid sm:grid-cols-2 gap-[20px]">
                  <div>
                    <label className="block text-[13px] font-bold uppercase tracking-[1px] text-[#69757B] mb-2">First Name</label>
                  ...
                  <div>
                    <label className="block text-[13px] font-bold uppercase tracking-[1px] text-[#69757B] mb-2">Last Name</label>
                ...
                <div>
                  <label className="block text-[13px] font-bold uppercase tracking-[1px] text-[#69757B] mb-2">Email</label>
                ...
                <div>
                  <label className="block text-[13px] font-bold uppercase tracking-[1px] text-[#69757B] mb-2">Subject</label>
                ...
                <div>
                  <label className="block text-[13px] font-bold uppercase tracking-[1px] text-[#69757B] mb-2">Message</label>
                ...
                <button type="button" className="inline-flex items-center gap-2 px-[30px] py-[19px] text-[14px] font-bold uppercase tracking-[1px] rounded-[3px] transition-all duration-200" style={{ background: '#E46C63', color: '#fff' }}>
