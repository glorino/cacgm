    ...
    <>
      ...
      <section className="relative pt-[160px] pb-[100px] text-center" style={{ background: '#1A374F' }}>
        <div className="max-w-[992px] mx-auto px-5">
          <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-[12px] font-bold uppercase tracking-[2px] text-[#E46C63] mb-3">About Us</motion.p>
      ...
      <section className="py-[100px]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-[30px]">
          <div className="grid md:grid-cols-2 gap-[30px]">
            <div className="p-[40px] rounded-[15px]" style={{ background: '#EFF4F4' }}>
              <div className="w-[50px] h-[50px] rounded-[3px] flex items-center justify-center mb-5" style={{ background: '#1A374F', color: '#fff' }}><Target size={22} /></div>
              <h3 className="text-[28px] font-['Arno_Pro',serif] text-[#222] mb-3">Our Mission</h3>
            ...
            <div className="p-[40px] rounded-[15px]" style={{ background: '#EFF4F4' }}>
              <div className="w-[50px] h-[50px] rounded-[3px] flex items-center justify-center mb-5" style={{ background: '#E46C63', color: '#fff' }}><Eye size={22} /></div>
              <h3 className="text-[28px] font-['Arno_Pro',serif] text-[#222] mb-3">Our Vision</h3>
      ...
      <section className="py-[100px]" style={{ background: '#EFF4F4' }}>
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-[30px]">
          <h2 className="text-[36px] md:text-[48px] font-['Arno_Pro',serif] text-center text-[#222] mb-[50px]">What We Stand For</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-[30px]">
            {[
              ...
              <div key={v.title} className="p-[30px] bg-white rounded-[15px]">
                <div className="w-[50px] h-[50px] rounded-[3px] flex items-center justify-center mb-4" style={{ background: '#EFF4F4', color: '#1A374F' }}>{v.icon}</div>
                <h3 className="text-[18px] font-bold text-[#222] mb-2">{v.title}</h3>
      ...
      <section className="py-[100px]">
        <div className="max-w-[1400px] mx-auto px-5 md:px-8 lg:px-[30px]">
          <h2 className="text-[36px] md:text-[48px] font-['Arno_Pro',serif] text-center text-[#222] mb-[50px]">Our Pastors</h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-[30px]">
            {[
              ...
              <div key={p.name} className="text-center p-[30px] rounded-[15px]" style={{ background: '#EFF4F4' }}>
                <div className="w-[80px] h-[80px] rounded-full mx-auto mb-4 flex items-center justify-center" style={{ background: 'rgba(26,55,79,0.1)', color: '#1A374F' }}><Church size={28} /></div>
                <h3 className="font-bold text-[16px] text-[#222]">{p.name}</h3>
                <p className="text-[14px] font-medium mt-1" style={{ color: '#E46C63' }}>{p.role}</p>
                <p className="text-[14px] text-[#69757B] mt-2 leading-relaxed">{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
